...
class TestProductModel(unittest.TestCase):
    ...
    def test_read_a_product(self):
        """It should read a product succusfully from the database"""
        product = ProductFactory()
        product.id = None
        product.create()
        self.assertIsNotNone(product.id)
    ...
    def test_update_a_product(self):
        ...
        self.assertEqual(found_product.id, current_id)
        self.assertEqual(found_product.name, product.name)
    ...
    def test_try_updating_a_product_with_no_id(self):
        """It should throw an error of id doesn't exist"""
        product = ProductFactory()
        product.id = None
    ...
    def test_find_product_by_name(self):
        """It should find a product from the database by name"""
        for _ in range(5):
            product = ProductFactory()
            product.create()
        products = Product.all()
    ...
    def test_find_product_by_availability(self):
        """It should find a product from the database by availability"""
        for _ in range(10):
            product = ProductFactory()
            product.create()
        products = Product.all()
    ...
    def test_find_product_by_category(self):
        """It should find a product from the database by category"""
        for _ in range(10):
            product = ProductFactory()
            product.create()
        products = Product.all()
    ...
    def test_find_product_by_prize(self):
        """It should find a product from the database by prize"""
        for _ in range(10):
            product = ProductFactory()
            product.create()
        products = Product.all()
