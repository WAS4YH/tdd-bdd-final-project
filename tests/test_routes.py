...
class TestProductRoutes(TestCase):
    ...
    def test_update_product(self):
        ...
        update_id = new_product["id"]
        response = self.client.put(f"{BASE_URL}/{update_id}", json=new_product)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_product(self):
        ...
        pre_count = self.get_product_count()
        self.assertEqual(pre_count, 5)
        ...
        post_count = self.get_product_count()
    ...
    def test_query_by_availability(self):
        ...
        found = [product for product in products if product.available == test_available]
        found_count = len(found)
